...
| `src/ts/zip-io.ts` | `PptxPackageBuilder`, `jp.igapyon.mikumsofficecore.ZipPackage` | Java uses the shared Office core ZIP/OPC helper; upstream writes a minimal stored zip. |
